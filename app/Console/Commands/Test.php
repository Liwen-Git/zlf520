...
class Test extends Command
{
    ...
    public function handle()
    {
        ...
        dd($json,$data);
            ...
            dd('调试状态关闭');
        $data = MarketingApi::getCanDiscountGoodsFromMarketing(2,[1,2],136,81,2,1);
        dd($data);
        dd(Cache::get('98c805e3b1ff2954f2b7d657920ea491'));
        ...
        FeeSplittingService::getUserFeeSplittingRatioToSelfByMerchantId(29);
        dd('ok');

        HotActStatisticsDaily::dispatch('2018-12-17');
        dd('ok');
