...
class ResultCode
{
    ...
    const SMS_SEND_REPEAT = 30010;  // 短信重复发送
    ...
    const WITHDRAW_PASSWORD_ERROR = 41001; // 提现密码错误
    ...
    const MARKETING_GOODS_EXPIRED = 80001;//活动商品过期
    const MARKETING_OVER_USER_LIMIT = 80002;//超出个人限额
    const STOCK_EMPTY = 80003;//库存为零
}