...
class MerchantExport implements FromQuery, WithMapping, WithHeadings
{
    ...
    protected $isPilot;
    protected $merchant_cat_id;

    public function __construct($id = '', $startDate = '',$endDate = '',$signboardName='', $name = '', $status = '', $settlementCycleType = '', $auditStatus = [], $operId = '', $operName = '', $merchantCategory = [], $isPilot = 0,$merchant_cat_id='')
    {
        $this->id = $id;
    ...
    public function query()
    {
        ...
        $query = MerchantService::getList([
            ...
            'merchant_cat_id' => $this->merchant_cat_id,
        ], true);
