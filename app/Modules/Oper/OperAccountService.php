...
use App\Modules\Cs\CsMerchantDraft;
...
class OperAccountService extends BaseService
{
    ...
    public static function login($username,$password)
    {
        ...
        $user->token = md5($user->account . time());
        $user->marketing_url = config('common.marketing_domain') . '/front/oper?token=' . $user->token;
        DataCacheService::setLoginCache('oper',$user);
        // 将用户信息记录到session中
        session([
    ...
    public static function logout()
    {
        ...
        DataCacheService::delLoginCache('oper',$user);
    ...
    public static function getMenus($operId)
    {
        ...
        $csMerchantDraftCount = CsMerchantDraft::where('oper_id', $operId)->count();
            ...
            $menus = [
                ...
                [ 'id' => 2, 'name' => '超市商户管理', 'level' => 1, 'url' => 'cs/merchant', 'sub' =>
                    [
                        ...
                        [ 'id' => 205, 'name' => '草稿箱('.$csMerchantDraftCount.')', 'level' => 2, 'url' => '/oper/cs/merchant/drafts', 'pid' => 2],
                    ]
...
//            ],
                ...
                [ 'id' => 13, 'name' => '平台活动', 'level' => 1, 'url' => 'activity', 'sub' =>
                    [
                        [ 'id' => 1301, 'name' => '年货节活动详情', 'level' => 2, 'url' => '/oper/activity_hot/activityDetail', 'pid' => 13,],
                        [ 'id' => 1302, 'name' => '年货节活动统计', 'level' => 2, 'url' => '/oper/activity_hot/statistics', 'pid' => 13,],
                    ]
                ],
