...
class MarketingController
{
    ...
    public function getGoodsListStart()
    {
        ...
        $current_device_no = request()->header('current-device-no');
    ...
    public function getMerchantGoodsListStart()
    {
        ...
        $params['is_sale'] = request('is_sale',0);
        $params['is_price'] = request('is_price',0);
        $params['type'] = request('type');
        $params['page'] = request('page');
        $params['pageSize'] = request('pageSize');
        ...
        if (!empty($data['data'])) {
            foreach ($data['data'] as $g) {
                ...
                $goods_info->marketing_started->marketing_id = $g['marketing_id'];
                $goods_info->marketing_started->phase_id = $g['phase_id'];
                $goods_info->marketing_started->end_time_left = strtotime($phase_started['end_time']) - time();
    ...
    public function userView()
    {
        ...
        $current_device_no = request()->header('device_no');
