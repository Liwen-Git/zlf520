...
class WithdrawController extends Controller
{
    ...
    public function exportExcel()
    {
        ...
        $query->with('merchant:id,name,oper_id,bank_card_type,bank_open_name,bank_card_no,bank_name,sub_bank_name,bank_province,bank_city,bank_area,bank_open_address');
        $query->with('oper:id,bank_open_name,bank_card_no,sub_bank_name,bank_open_address');
        $query->with('csMerchant:id,name,oper_id,bank_card_type,bank_open_name,bank_card_no,bank_name,sub_bank_name,bank_province,bank_city,bank_area,bank_open_address');
