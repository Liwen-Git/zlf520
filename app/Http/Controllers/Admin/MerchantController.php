...
class MerchantController extends Controller
{
    ...
    public function getList()
    {
        ...
        $merchant_cat_id_1_level1 = request('merchant_cat_id_1_level1');
        $merchant_cat_id_1_level2 = request('merchant_cat_id_1_level2');
        $merchant_cat_id = '';
        if (!empty($merchant_cat_id_1_level2)) {
            $merchant_cat_id = $merchant_cat_id_1_level2;
        } elseif (!empty($merchant_cat_id_1_level1)) {
            $merchant_cat_id = MerchantCategoryService::getSubCategoryIds($merchant_cat_id_1_level1);
        }
...
//        $creatorOperName = request('creatorOperName');
        ...
        return (new MerchantExport($id, $startDate, $endDate,$signboardName, $name, $status, $settlementCycleType, $auditStatus, $operId, $operName, $merchantCategory, $isPilot,$merchant_cat_id))->download('商户列表.xlsx');
    }
    ...
    public function getSubCat()
    {
        ...
        $rt = MerchantCategoryService::getSubCategories($parent_id);
