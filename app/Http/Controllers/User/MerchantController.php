...
class MerchantController extends Controller
{
    ...
    public function detail()
    {
        ...
        $allowAuditStatus = [
            ...
            Merchant::AUDIT_STATUS_RESUBMIT,
        ];
        if(!$detail||$detail->status!=Merchant::STATUS_ON||!in_array($detail->audit_status,$allowAuditStatus)){
        ...
        //商家是否被当前用户关注
        $isFollows = MerchantFollow::where('merchant_id',$id)
