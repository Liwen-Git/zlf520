...
Route::prefix('user')
    ...
    ->middleware('user')->group(function (){
        ...
        Route::any('order/reminderDeliver', 'OrderController@reminderDeliver')->middleware(UserLoginFilter::class);
        ...
        Route::get('dishes/good', 'DishesController@getDishesGood');
        ...
        Route::get('poster','QRCodePosterController@getPoster')->middleware(UserLoginFilter::class);
        ...
        Route::get('share/getUserShareToken', 'ShareController@getUserShareToken');

        Route::get('dqad/getByPosition','AdController@getByPosition');

        Route::get('groupBook/getGoodsList','GroupBookController@getGoodsList');
        Route::get('groupBook/orders','GroupBookController@getOrdersList');
    });
