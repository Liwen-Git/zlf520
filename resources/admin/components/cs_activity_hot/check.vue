<template>
    <page title="商品详细" :breadcrumbs="{活动商品列表: '/activity_hot/cs_goods'}" v-loading="isLoading">
        <el-row>
            <el-col :span="22">
                <el-form label-width="120px">
                    ...
                    <el-form-item prop="audit_suggestion" label="上一次审核意见">
                        {{goods.audit_suggestion}}
                    </el-form-item>
                    <el-form-item prop="cs_merchant_name" label="商户名称">
                        {{goods.cs_merchant_name}}
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDetail(){
                this.isLoading = true;
                api.get('cs/activity_hot/goods/detail', {id: this.id,}).then(data => {
                    this.goods = data;
                }).finally(() => {
