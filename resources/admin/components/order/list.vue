        ...
        <el-table :data="list" stripe v-loading="isLoading">
                ...
                <template slot-scope="scope">
                    <el-col :span="14">
                        <el-form label-position="left" inline class="table-expand" label-width="100px">
                            ...
                            <el-form-item label="商家秀推荐人">
                                <span v-if="scope.row.ybk_anchor">
                                    {{scope.row.ybk_anchor.nickname}}
                                </span>
                            </el-form-item>
            ...
            <el-table-column prop="status" label="订单状态">
                <template slot-scope="scope">
                    ...
                    <span v-else-if="parseInt(scope.row.status) === 4" class="c-green" >待使用</span>
