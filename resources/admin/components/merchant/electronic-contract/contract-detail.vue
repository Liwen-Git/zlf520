<template>
    <el-row :gutter="20">
        <el-col>
            <div>协议编号：【{{electronicContract.el_contract_no}}】</div>
            <p>本《大千生活商户合作协议》（以下简称“本协议”）由以下各方于{{electronicContract.sign_time}}签署：</p>
            <p><b>甲方：深圳大千生活科技有限公司</b></p>
            <p>统一社会信用代码：91440300MA5FAC9C21</p>
            <p>注册地址：深圳市福田区莲花街道景田社区商报东路149号景龙大厦一栋15C</p>
            <p>电话：0755-32983328-8004</p>
            <p><b>乙方：{{electronicContract.merchant.name}}</b></p>
            <p>统一社会信用代码：{{electronicContract.merchant.organization_code}}</p>
            <p>注册地址：{{electronicContract.merchant.province + electronicContract.merchant.city + electronicContract.merchant.area + electronicContract.merchant.address}}</p>
            <p>联系人：{{electronicContract.merchant.contacter}}</p>
            <p>电话：{{electronicContract.merchant.contacter_phone}}</p>
            ...
            <div><b>三、合作期限</b></div>
            <p>甲乙双方合作期限为自本协议生效之日起【1】年，即{{electronicContract.sign_time}}至{{electronicContract.expiry_time}}。除非本协议到期前三十日内，其中一方向另一方书面提出终止合作，否则本协议期限届满后将自动延续【1】年，延续次数不限。</p>
            <div><b>四、甲方的权利与义务</b></div>
            ...
            <p>5.3.1 乙方应以其在甲方平台提供产品和服务所产生的销售额为基数计算应向甲方支付的服务费，服务费的计算标准为：每笔交易销售额的【{{electronicContract.merchant.settlement_rate}}】%。乙方同意，在本协议有效期内，在甲方通过平台公告、邮件方式或其他书面方式将服务费调整方案通知乙方后，乙方即按照调整后的服务费计算标准向甲方支付服务费。</p>
            <p>5.3.2 消费者通过甲方平台购买乙方产品或服务的，其所支付的款项由甲方代乙方收取，消费者按照甲方平台指引支付至甲方账户。在甲方账户收到消费者支付的前述款项后两个工作日内，甲方应将扣除本条第5.3.1项约定的服务费及第三方支付平台收取的交易手续费（具体费用由第三方支付平台按一定费率收取）后的剩余款项支付至乙方指定的账户。乙方指定的账户原则上应当为乙方对公银行账户或者乙方营业执照所显示的经营者银行账户，否则甲方有权要求乙方提供相应的授权文件及其他证明文件，并顺延相应款项（即扣除相应服务费及交易手续费后的剩余款项）的支付时间（在原基础上至少再延长三个工作日，即在甲方账户收到消费者支付的款项后五个工作日内），由此产生的一切法律责任和导致甲方受到的损失和支出的额外费用，均由乙方承担。</p>

            <div><b>乙方指定账户信息如下：</b></div>
            <p>户名：【{{electronicContract.merchant.bank_open_name}}】</p>
            <p>开户行：【{{electronicContract.merchant.bank_name}}】</p>
            <p>账号：【{{electronicContract.merchant.bank_card_no}}】</p>
