<template>
    <page title="商品详细" :breadcrumbs="{商品列表: '/cs/goods'}" v-loading="isLoading">
        <el-row>
            <el-col :span="22">
                <el-form label-width="120px">
                    ...
                    <el-form-item prop="status_name" label="审核状态">
                        ...
                        <div  v-else-if="parseInt(goods.audit_status) === 3" class="c-danger"><span>审核不通过</span><span class="message" v-if="goods.audit_suggestion">（{{goods.audit_suggestion}}）</span></div>
                        <span v-else>未知 ({{goods.status}})</span>
                    </el-form-item>
