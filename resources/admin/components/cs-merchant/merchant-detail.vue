            ...
            <el-form label-width="120px" label-position="left" size="small">
                ...
                <el-col :span="11">
                    ...
                    <el-form-item label="营业执照">
                        ...
                        <el-button v-if="data.business_licence_pic_url" :class="checkIsset('business_licence_pic_url') ? 'c-danger':''" type="text" @click="previewImage('licence')">查看</el-button>
                    </el-form-item>
                ...
                <el-col :span="11" :offset="1">
                    <el-form-item v-show="this.isShowAuditMessage==true" prop="" label="商户审核状态">
                        <span>{{ {1: '待审核', 2: '审核通过', 3: '审核不通过', 4: '撤回',}[data.audit_status] }}</span>
                    </el-form-item>
                    <el-form-item v-show="this.isShowAuditMessage==false" prop="" label="商户审核状态">
                        <span>{{ {0: '待审核', 1: '审核通过', 2: '审核不通过', 3: '重新提交审核',}[data.audit_status] }}</span>
                    </el-form-item>
                    <el-form-item prop="id" label="商户ID">
                        <span v-if="data.cs_merchant_id > 0">{{data.cs_merchant_id}}</span>
                    </el-form-item>
                    ...
                    <el-form-item prop="address" label="详细地址">
                        <template v-if="checkIsset('address')">
                            <el-tooltip class="item" effect="dark" :content="data.changeData.address" placement="bottom">
                                <span class="c-danger">{{data.address}}</span>
                            </el-tooltip>
                        </template>
                        <template v-else>
                ...
                <el-col v-if="type != 'poolOnly'">
                    ...
                    <el-col :span="11">
                        ...
                        <el-form-item prop="logo" label="商家logo" :class="checkIsset('logo') ? 'c-danger':''" >
                            <div v-viewer>
                                <img :src="data.logo" alt="商家logo" width="190px" height="190px" />
                            </div>
                            <!-- <preview-img :url="data.logo" width="50px" height="50px"/> -->
                        </el-form-item>
                        <el-form-item prop="desc_pic" label="商家介绍图片" :class="checkIsset('desc_pic') ? 'c-danger':''">
                        ...
                        <el-form-item v-if="data.bank_card_type == 2" required label="法人银行卡正面照" prop="bank_card_pic_a" :class="checkIsset('bank_card_pic_a') ? 'c-danger':''" >
                            <div v-viewer>
                        ...
                        <el-form-item label="法人身份证正反面" :class="checkIsset('legal_id_card_pic_a') ? 'c-danger':''">
                            <div v-viewer>
                        ...
                        <el-form-item label="合同" :class="checkIsset('contract_pic_url') ? 'c-danger':''">
                        ...
                        <el-form-item prop="other_card_pic_urls" label="其他证件" :class="checkIsset('other_card_pic_urls') ? 'c-danger':''">
                            <div v-viewer>
                        ...
                        <el-col v-if="data.audit_status == 1 && isAudit==true" >
                ...
                <el-col v-if="data.audit_status == 1"  >
                    <el-form-item>
                        <el-button type="success" @click="audit(1)" v-show="isAudit">审核通过</el-button>
                        <el-button type="warning" @click="audit(2)" v-show="isAudit">审核不通过</el-button>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            if(this.$route.path.indexOf('unaudits')!==-1&&this.isAudit!=true){
                this.isShowAuditMessage = true;
            }
            if(this.$route.path=='/cs/merchant/detail'){
                // 如果为超市商户详情页面
                this.isMerchant = true;
            }
            console.log('this.$route.path==/cs/merchant/detail',this.isMerchant)
            console.log('this.$route.path',this.$route.path,this.isMerchant)
            console.log('audit_status',this.audit_status)
        },
        components: {
            previewImg,
            imgPreviewDialog,
