<template>
    <el-form :model="form" size="small" label-width="165px" :rules="formRules" ref="form" @submit.native.prevent>
        ...
        <el-col :span="11">
            ...
            <el-form-item v-show="form.bank_card_type == 1" prop="licence_pic_url" label="开户许可证">
                <image-upload v-model="form.licence_pic_url" :limit="1"/>
            </el-form-item>
            <el-form-item v-show="form.bank_card_type == 2"  label="法人银行卡正面照" prop="bank_card_pic_a">
                <image-upload v-model="form.bank_card_pic_a" :limit="1"/>
            </el-form-item>
            <!-- 银行卡信息 end -->
