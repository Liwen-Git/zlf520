                    ...
                    <span @click.stop="() => {}">
                        <el-dropdown @command="(command) => categoryDropdownClicked(command, data)" trigger="click">
                            ...
                            <el-dropdown-menu slot="dropdown" class="dropmenu">
                                ...
                                <el-dropdown-item command="up" v-if="data.allowUp ==  1">上移</el-dropdown-item>
                                <el-dropdown-item v-else disabled>上移</el-dropdown-item>
                                <el-dropdown-item command="down" v-if="data.allowDown ==  1">下移</el-dropdown-item>
                                <el-dropdown-item v-else disabled>下移</el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </span>
                </span>
                ...
                <el-col :span="16">
                    <el-form ref="form" :model="form" :rules="formRules" label-width="120px" size="small">
                        ...
                        <el-form-item prop="icon" label="类目图标" v-if="form.pid == 0">
                            <image-upload v-if="showForm" v-model="form.icon" :limit="1"></image-upload>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            up(data){
                api.post('/merchant/category/up', {id: data.id}).then(result => {
                    if(result.isChanged){
                        this.getList();
                    }
                });
            ...
            down(data){
                api.post('/merchant/category/down', {id: data.id}).then(result => {
                    if(result.isChanged){
                        this.getList();
                    }
                });
