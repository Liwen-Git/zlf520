<template>
    <el-container class="container">
        <el-header class="header">
            <el-container>
                ...
                <el-main class="header-main" :style="{'background-color': theme.color, 'color': theme.menuTextColor}">
                    ...
                    <div class="fl top-menu" @click="toMarketing"> 营销系统 </div>
        ...
        <el-container>
            <el-aside class="left-menu-container" style="width: auto;">
                <leftMenu style="height: 100%" :collapse="collapseLeftMenu" :menus="menus" ref="leftMenu"/>
            </el-aside>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            toMarketing() {
                window.open(this.user.marketing_url);
            }
...
<style scoped>
    ...
    .left-menu-container::-webkit-scrollbar-track {/*滚动条里面轨道*/
