<template>
    <page title="参数配置">
        <el-form v-model="form" v-loading="formLoading" label-width="200px">
            ...
            <el-form-item label="开启云主播编号" prop="ybk_anchor_on">
                <el-switch
                        v-model="form.ybk_anchor_on"
                        :active-value="1"
                        :inactive-value="0"
                >
                </el-switch>
                <span class="tips">开启云主播编号</span>
            </el-form-item>
            <el-form-item label="小程序当前版本" prop="miniprogram_current_version">
                <el-input width="100px" v-model="form.miniprogram_current_version" placeholder="小程序当前版本"></el-input>
            </el-form-item>
            <el-form-item>
